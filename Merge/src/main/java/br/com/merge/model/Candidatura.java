...
public class Candidatura {
	 ...
	 */
	private String status, resultado, dataCadastro, dataInscricao, dataFimInscricao;
	...
	public Candidatura(int codigo, int codigoVaga, int codigoCandidato, String status,
			String resultado, int score, String dataCadastro, String dataInscricao,
	...
	/**
	 * Retorna a data de inscriação
	 * @return data de inscriação
	 */	
	...
	/**
	 * Altera a data de inscriação
	 * @param data de inscriação
	 */
	...
	/**
	 * Retorna a data de limite de inscrição
	 * @return data de limite de inscrição
	 */	
	...
	/**
	 * Altera a data de limite de inscrição
	 * @param data de limite de inscrição
	 */
